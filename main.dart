      ...
      body: Center(
        child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                "Fashan Saraya", style: TextStyle(color: Colors.white, fontSize: 20.0, height: 2.0, fontWeight: FontWeight.bold,),),
              Text(
                      ...
                      child: Card(
                          ...
                          child: Column (
                            children: <Widget>[Icon(Icons.home, size: 110, color: Colors.yellow,),
                              Text('Penyabangan',style: TextStyle(color: Colors.yellow, fontSize: 17.0, height: 2.0, fontWeight: FontWeight.bold,),)],
                          )
                      ),
                    )
                  ],
                  ...
                  children:<Widget> [
                    Expanded(
                      child: Card(
                          ...
                          margin: EdgeInsets.only(left: 10.0, right: 10.0),
                          child: Column (
                            children: <Widget>[Icon(Icons.movie, size: 110, color: Colors.purple,),
